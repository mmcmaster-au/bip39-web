...
```
 ...
 ```javascript
> await bip39.entropyToMnemonicAsync('00000000000000000000000000000fff')
...
const mnemonic = await bip39.generateMnemonicAsync()
// => 'seed sock milk update focus rotate barely fade car face mechanic mercy'

(await bip39.mnemonicToSeedAsync('basket actual')).toString('hex')
// => '5cf2d4a8b0355e90295bdfc565a022a409af063d5365bb57bf74d9528f494bfa4400f53d8349b80fdae44082d7f9541e1dba2b003bcfec9d0d53781ca676651f'

await bip39.mnemonicToSeedAsync('basket actual')
...
bip39.mnemonicToSeedAsync('basket actual').then(bytes => bytes.toString('hex')).then(console.log)
// => '5cf2d4a8b0355e90295bdfc565a022a409af063d5365bb57bf74d9528f494bfa4400f53d8349b80fdae44082d7f9541e1dba2b003bcfec9d0d53781ca676651f'

await bip39.mnemonicToSeedAsync('basket actual', 'a password')
...
await bip39.validateMnemonicAsync(mnemonic)
// => true

await bip39.validateMnemonicAsync('basket actual')
// => false
```
...
const mnemonic = await bip39.entropyToMnemonicAsync('00000000000000000000000000000000')
// => abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon about

// reversible
await bip39.mnemonicToEntropyAsync(mnemonic)
